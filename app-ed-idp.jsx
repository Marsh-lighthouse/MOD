...
function EdPlanView({ onBack, onRestart }) {
  ...
  const statusMeta = {
    draft: { label: "Draft", color: "var(--ink)", bg: "var(--status-neutral-bg)", border: "#94918C" },
    "under-review": { label: "Under review", color: "var(--ink)", bg: "color-mix(in srgb, #CB7E03 15%, var(--card))", border: "#CB7E03" },
    approved: { label: "Approved", color: "var(--ink)", bg: "color-mix(in srgb, #14853D 15%, var(--card))", border: "#14853D" },
  };
  ...
  return (
    <div style={{ maxWidth: "var(--content-max)", margin: "36px var(--fol-mx) 72px", padding: 0 }}>
      ...
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
        ...
        <span style={{ fontFamily: "var(--sans)", fontSize: 15, fontWeight: 400, color: sm.color, background: sm.bg, border: "1px solid " + sm.border, padding: "6px 13px", borderRadius: 6, marginTop: 8, whiteSpace: "nowrap" }}>{sm.label}</span>
      </div>
