...
(function () {
  var BRANDS = {
    ...
    mod: {
      id: "mod", label: "MOD", dot: "#D6BA77",
      // MOD gold (#D6BA77) is a LIGHT fill — CTA/label text on it must be dark (white
      // fails AA). Accent is the brand's dark teal for links/secondary on light bg.
      vars: { "--primary": "#D6BA77", "--accent": "#29504D", "--action": "#D6BA77", "--action-text": "#1A1A1A" },
      ...
      logo: "brand/clients/mod.svg?v=1789712000", logoWhite: "brand/clients/mod-white.svg?v=1789712000",
      icon: "brand/clients/mod-icon.svg?v=1789712000", iconWhite: "brand/clients/mod-icon-white.svg?v=1789712000",
  ...
  var SLUG_OF = { marsh: "marsh", generali: "general", mod: "mod" };   // id → url slug
  var ID_OF = { marsh: "marsh", general: "generali", generali: "generali", mod: "mod" }; // slug/alias → id
