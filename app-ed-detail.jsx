...
// ── status helpers ──
const edStatusMeta = {
  complete: { label: "Done", color: "var(--ink)", bg: "color-mix(in srgb, #14853D 15%, var(--card))", border: "#14853D" },
  progress: { label: "In progress", color: "var(--ink)", bg: "color-mix(in srgb, var(--accent) 15%, var(--card))", border: "var(--accent)" },
  notstarted: { label: "Not started", color: "var(--ink)", bg: "var(--status-neutral-bg)", border: "#94918C" },
  locked: { label: "Locked", color: "var(--ink)", bg: "var(--status-neutral-bg)", border: "#94918C" }
};

function EdBadge({ status }) {
  const m = edStatusMeta[status] || edStatusMeta.locked;
  return <span style={{ fontFamily: "var(--sans)", fontSize: 15, fontWeight: 400, color: m.color, background: m.bg, border: "1px solid " + m.border, padding: "4px 11px", borderRadius: 6, whiteSpace: "nowrap" }}>{m.label}</span>;
}
    ...
    style={{ display: "flex", alignItems: "center", gap: 16, background: eCARD, border: "1px solid " + eLINE, borderRadius: 14, padding: "16px 18px", opacity: locked ? 0.6 : 1, cursor: locked || !onClick ? "default" : "pointer" }}>
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 9, flexWrap: "wrap" }}>
          ...
          {item.hasReport && <span style={{ fontFamily: "var(--sans)", fontSize: 15, fontWeight: 400, color: "var(--ink)", background: "color-mix(in srgb, var(--accent) 15%, var(--card))", border: "1px solid var(--accent)", padding: "4px 10px", borderRadius: 5 }}>Report ready</span>}
        </div>
...
function EdTasks({ prog, onBack, onOpenCenter, onProctored, onOpenAssess, onSchedule, heroStyle = "light", tasksLayout = "standard" }) {
  ...
  <div style={{ background: "var(--surface-deep)", borderRadius: 20, padding: "34px 36px", position: "relative", overflow: "hidden", marginBottom: 40 }}>
      ...
      <div style={{ position: "relative" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
          <span style={{ fontFamily: "var(--sans)", fontSize: 15, fontWeight: 400, color: "var(--ink)", background: "color-mix(in srgb, var(--accent) 15%, var(--card))", border: "1px solid var(--accent)", padding: "4px 11px", borderRadius: 6 }}>In progress</span>
        </div>
  ...
  <div style={{ marginBottom: 40 }}>
      <span style={{ display: "inline-block", fontFamily: "var(--sans)", fontSize: 15, fontWeight: 400, color: "var(--ink)", background: "color-mix(in srgb, var(--accent) 15%, var(--card))", border: "1px solid var(--accent)", padding: "4px 11px", borderRadius: 6, marginBottom: 14 }}>In progress</span>
  ...
  <div style={{ marginBottom: 30 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 13, flexWrap: "wrap", rowGap: 8, marginBottom: 15 }}>
        ...
        <span style={{ display: "inline-block", fontFamily: "var(--sans)", fontSize: 15, fontWeight: 400, color: "var(--ink)", background: "color-mix(in srgb, var(--accent) 15%, var(--card))", border: "1px solid var(--accent)", padding: "4px 11px", borderRadius: 6 }}>In progress</span>
      </div>
  ...
  <div style={{ display: "flex", gap: 16, marginBottom: 34 }}>
      ...
      <div style={{ flex: 1 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap" }}>
          ...
          <span style={{ fontFamily: "var(--sans)", fontSize: 15, fontWeight: 400, color: "var(--ink)", background: "color-mix(in srgb, var(--accent) 15%, var(--card))", border: "1px solid var(--accent)", padding: "5px 12px", borderRadius: 6 }}>In progress</span>
        </div>
  ...
  <div style={{ display: "flex", alignItems: "center", gap: 24, flexWrap: "wrap", background: eCARD, border: "1px solid " + eLINE, borderRadius: 18, padding: "20px 26px 20px 30px", marginBottom: 36, position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ flex: 1, minWidth: 200 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 7 }}>
          <span style={{ fontFamily: "var(--sans)", fontSize: 15, fontWeight: 400, color: "var(--ink)", background: "color-mix(in srgb, var(--accent) 15%, var(--card))", border: "1px solid var(--accent)", padding: "4px 10px", borderRadius: 6 }}>In progress</span>
        </div>
          ...
          <div style={{ display: "flex", alignItems: "flex-start", gap: 14, marginBottom: 18 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap", marginBottom: 4 }}>
                ...
                <span style={{ fontFamily: "var(--sans)", fontSize: 15, fontWeight: 400, letterSpacing: ".04em", textTransform: "uppercase", color: "var(--ink)", background: "color-mix(in srgb, #14853D 15%, var(--card))", border: "1px solid #14853D", padding: "4px 10px", borderRadius: 5 }}>Completed</span>
              </div>
...
function ScBadge({ state }) {
  const m = {
    pending: { bg: scTint(eBLUE, "12%"), bd: eBLUE, ic: <span className="ed-spin" style={{ width: 12, height: 12, borderRadius: "50%", border: "2px solid " + scTint(eBLUE, "40%"), borderTopColor: eBLUE, display: "block" }} />, l: "Pending" },
    pass: { bg: scTint(eSUCCESS, "14%"), bd: eSUCCESS, ic: <I.checkCircle size={13} />, l: "Pass" },
    fail: { bg: scTint(eDANGER, "12%"), bd: eDANGER, ic: <I.alertCircle size={13} />, l: "Fail" },
  }[state] || {};
  return <span style={{ display: "inline-flex", alignItems: "center", gap: 6, fontFamily: "var(--sans)", fontSize: 13, fontWeight: 700, color: "var(--ink)", background: m.bg, border: "1px solid " + m.bd, padding: "4px 11px", borderRadius: 6, whiteSpace: "nowrap" }}>{m.ic} {m.l}</span>;
}
