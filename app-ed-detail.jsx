...
function EdBadge({ status }) {
  ...
  return <span style={{ fontFamily: "var(--sans)", fontSize: 15, fontWeight: 400, color: m.color, background: m.bg, border: "1px solid " + m.border, padding: "4px 11px", borderRadius: 2, whiteSpace: "nowrap" }}>{m.label}</span>;
}
...
function ScBadge({ state }) {
  ...
  return <span style={{ display: "inline-flex", alignItems: "center", gap: 6, fontFamily: "var(--sans)", fontSize: 13, fontWeight: 700, color: "var(--ink)", background: m.bg, border: "1px solid " + m.bd, padding: "4px 11px", borderRadius: 2, whiteSpace: "nowrap" }}>{m.ic} {m.l}</span>;
}
