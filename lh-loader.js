...
(function () {
  ...
  function injectStyles() {
    ...
    css.textContent =
      ...
      "#lh-loader .lh-l-ring circle{fill:none;stroke:var(--accent,#29504D);stroke-width:2.5;stroke-linecap:round;}" +
      "#lh-loader .lh-l-flash{position:absolute;width:96px;height:96px;border-radius:50%;background:radial-gradient(circle,color-mix(in srgb, var(--accent,#29504D) 55%, transparent),transparent 68%);opacity:0;transform:scale(.4);animation:lhl-flash .55s ease-out .78s;}" +
      ...
      "#lh-loader .lh-l-mark .lh-l-right{fill:var(--primary,#D6BA77);animation:lhl-in-r .8s cubic-bezier(.16,1,.3,1) .12s forwards;}" +
      "#lh-loader .lh-l-mark .lh-l-left{fill:var(--primary,#D6BA77);animation:lhl-in-l .8s cubic-bezier(.16,1,.3,1) .12s forwards;}" +
      ...
      "#lh-loader .lh-l-bar i{display:block;height:100%;width:40%;border-radius:2px;background:var(--accent,#29504D);animation:lhl-slide 1.15s ease-in-out infinite;}" +
