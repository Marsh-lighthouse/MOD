  ...
  if (c360Step === "home") return (
    <div style={wrap}>
      <div style={{ marginBottom: 16 }}>
        <span style={{ fontFamily: "var(--sans)", fontSize: 15, fontWeight: 400, color: "var(--ink)", background: "color-mix(in srgb, var(--accent) 15%, var(--card))", border: "1px solid var(--accent)", padding: "4px 11px", borderRadius: 6, whiteSpace: "nowrap" }}>In progress</span>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: isMob ? "1fr" : "1fr 1fr", gap: 16, gridAutoRows: "1fr" }}>
        ...
        <div onClick={() => setC360Step(c360SelfDone ? "selfDone" : "selfIntro")} style={{ cursor: "pointer", padding: 24, background: qCARD, border: "1px solid " + qLINE, borderRadius: cr, transition: "border-color .2s, transform .2s", display: "flex", flexDirection: "column" }}
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
            ...
            {c360SelfDone && <div style={{ display: "flex", alignItems: "center", gap: 4, padding: "4px 10px", borderRadius: 99, background: "color-mix(in srgb, #14853D 15%, var(--card))", border: "1px solid #14853D", color: "var(--ink)", fontSize: 15, fontWeight: 400, fontFamily: "var(--sans)" }}><QI.Check s={11} /> Done</div>}
          </div>
        ...
        <div onClick={() => setC360Step("report")} style={{ cursor: "pointer", padding: 24, background: qCARD, border: "1px solid " + qLINE, borderRadius: cr, transition: "border-color .2s, transform .2s", display: "flex", flexDirection: "column", opacity: responseRate >= 60 ? 1 : .9 }}
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 14 }}>
            ...
            {responseRate >= 60 ? (
              <div style={{ display: "flex", alignItems: "center", gap: 4, padding: "4px 10px", borderRadius: 99, background: "color-mix(in srgb, var(--accent) 15%, var(--card))", border: "1px solid var(--accent)", color: "var(--ink)", fontSize: 15, fontWeight: 700, fontFamily: "var(--sans)" }}>Ready</div>
            ) : (
          ...
          {roster.map((r, i) => {
            ...
            return (
              <div key={r.id} style={{ display: "flex", alignItems: "center", gap: 14, padding: "14px 18px", borderTop: i > 0 ? "1px solid " + qLINE : "none" }}>
                ...
                <div style={{ padding: "4px 10px", borderRadius: 99, background: stCfg.bg, color: "var(--ink)", border: "1px solid " + stCfg.bd, fontSize: 15, fontWeight: 400, fontFamily: "var(--sans)", flexShrink: 0 }}>{stCfg.l}</div>
