...
function AssessorEditorial() {
  ...
  const StatusPill = ({s}) => {
    ...
    return <span style={{fontFamily:f,fontSize:14,fontWeight:400,color:"var(--ink)",background:cfg.bg,border:`1px solid ${cfg.br||cfg.c}`,boxSizing:"border-box",padding:"4px 11px",borderRadius:6,whiteSpace:"nowrap"}}>{s}</span>;
  };
